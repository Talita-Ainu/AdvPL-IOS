...
User Function AdcAluno()
    Local aAluno := {} //Array()

// Insirindo 5 linhas e cada linha os dados

    aAdd(aAluno, {"Amarelo", 7, 87,"Programador Cobol"})
    aAdd(aAluno, {"Lucas 1", 10, 22, "Jogador de CS"})
    aAdd(aAluno, {"Ualace", 2, 22,"Instrutor"})
    aAdd(aAluno, {"Castanhari",0.10,23,"Youtuber"})
    aAdd(aAluno, {"Thor RS",6,24,"Do Sul"})

// acessando o 5 aluno e o nome
    Alert("Nome do aluno: " + aAluno[5,1] +; 
        "Media: " + cValToChar(aAluno[5,2]) +;
